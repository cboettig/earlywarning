`ro warning=FALSE, message=FALSE, comment=NA, tidy=FALSE, cache=TRUE, verbose=TRUE, refresh="ready" or`
...
We also consider the discrete time version of the model of `r citet("10.1038/269471a0")`,
